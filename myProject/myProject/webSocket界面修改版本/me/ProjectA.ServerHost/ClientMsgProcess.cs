...
namespace Aviad.ProjectA.ServerHost
{
    ...
    {
        public delegate void onClientPublishMessage(string msg,Fleck.IWebSocketConnection sock, GlobalMessage type);
        ...
        public delegate void onSendMsgToClient(string msg, Fleck.IWebSocketConnection sock, GlobalMessage type);
        ...
        public bool verify(string head)
        {
        ...
        string login(string msg, Fleck.IWebSocketConnection clientSock)
        {
            ...
            else
            {
                ...
                sendMsgToClient(total, clientSock, GlobalMessage.RETURN);
            }
            return msg;
        ...
        string serverCreateConfRoomAck(string msg, Fleck.IWebSocketConnection clientSock)
        {
			return msg;
        ...
        string setOperatorNumber(string msg, Fleck.IWebSocketConnection clientSock)
        {
        ...
        string muteConfMember(string msg, Fleck.IWebSocketConnection clientSock)
        {
        ...
        string setConfBroadcast(string msg, Fleck.IWebSocketConnection clientSock)
        {
