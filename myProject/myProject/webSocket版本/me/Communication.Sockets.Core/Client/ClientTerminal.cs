...
namespace Communication.Sockets.Core.Client
{
    public class ClientTerminal
    {
        ...
        public void createSocket(IPAddress remoteIPAddress, int alPort)
        {
            //create a new client socket ...
            m_socClient = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            remoteEndPoint = new IPEndPoint(remoteIPAddress, alPort);
        }
        ...
        public void SendMessage(string message)
        {
            ...
            byte[] byData = System.Text.Encoding.UTF8.GetBytes(message);
